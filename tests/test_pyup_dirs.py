...
def iter_py_files(tmp_pathplus: PathPlus):
	...
	with in_directory(tmp_pathplus), fail_on_systemexit():
		assert list(pyupgrade_directories.iter_py_files([tmp_pathplus.as_posix()])) == []

	with in_directory(tmp_pathplus), fail_on_systemexit():
		assert list(pyupgrade_directories.iter_py_files([tmp_pathplus.as_posix()], recursive=True)) == []
