...
The ``pyupgrade-directories`` source code is available on GitHub,
...
The recommended way to build ``pyupgrade-directories`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
