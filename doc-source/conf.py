...
github_url = f"https://github.com/domdfcoding/pyupgrade-directories"

rst_prolog = f""".. |pkgname| replace:: pyupgrade-directories
.. |pkgname2| replace:: ``pyupgrade-directories``
...
language = 'en'
package_root = "pyupgrade_directories"
...
html_context = {
		...
		'github_repo': 'pyupgrade-directories',
